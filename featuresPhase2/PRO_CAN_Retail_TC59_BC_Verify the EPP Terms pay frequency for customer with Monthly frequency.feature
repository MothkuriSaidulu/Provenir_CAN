...
##Scenario:: (#45P2) PRO_CAN_Retail_TC59_BC_Verify the EPP Terms pay frequency for customer with Monthly frequency
Feature: PRO_CAN_Retail_TC59_BC_Verify the EPP Terms pay frequency for customer with Monthly frequency

  @SPLEPPApproved
   Scenario: PRO_CAN_Retail_TC59_BC_Verify the EPP Terms pay frequency for customer with Monthly frequency|TC59_2SplCls_EPP_Monthly
   Given Genareted sin
