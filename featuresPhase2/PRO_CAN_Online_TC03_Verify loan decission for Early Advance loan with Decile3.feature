##Scenario:: TC03_Verify loan decission for Early Advance loan with Decile3
Feature: TC03_Verify loan decission for Early Advance loan with Decile3

  @ILRefinanceApproved
  Scenario: TC03_Verify loan decission for Early Advance loan with Decile3|TC03_D3_EA_Appr 
    Given Genareted sin
    ...
    And Run the TU query general D "3" and FICO score "619"
