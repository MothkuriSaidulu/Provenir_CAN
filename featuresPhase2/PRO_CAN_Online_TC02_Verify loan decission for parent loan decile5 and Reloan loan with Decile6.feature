##Scenario:: TC02_Verify loan decission for parent loan decile5 and Reloan loan with Decile6
Feature: TC02_Verify loan decission for parent loan decile5 and Reloan loan with Decile6

  @ILreloanApproved
  Scenario: TC02_Verify loan decission for parent loan decile5 and Reloan loan with Decile6|TC02_P5R6_IL_Aprvd
   Given Genareted sin
