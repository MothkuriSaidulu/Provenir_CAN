##Scenario:: CAN_SK_IL_Online_Verify the loan term for second reloan when loan amount < 1000
Feature: TC36_CAN_SK_IL_Online_Verify the loan term for second reloan when loan amount < 1000

  @ILreloanApproved
  Scenario: TC36_CAN_SK_IL_Online_Verify the loan term for second reloan when loan amount < 1000|TC36_IL_2Reloan_Lt1k
   ...
   ######################################And select the flink consent Not come for SK
   ...
   #################################And select the flink consent new UI Not needed for SK 
   ###And Verify the customer information new UI###
   And Verify the customer information new UI Monthly SK
   And signed the picra and submit application
   And upload document
   And verify the loan status and update loan status in DB
   And click on Finalize and e-Sign Loan Documents 
