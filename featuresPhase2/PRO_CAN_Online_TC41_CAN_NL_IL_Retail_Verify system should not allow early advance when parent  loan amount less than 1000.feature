##Scenario:: CAN_NL_IL_Retail_Verify system should not allow early advance when parent  loan amount < 1000
Feature: TC41_CAN_NL_IL_Retail_Verify system should not allow early advance when parent  loan amount < 1000

  @ILRefinanceApproved
  Scenario: TC41_CAN_NL_IL_Retail_Verify system should not allow early advance when parent  loan amount < 1000|TC41_EA_Decl_PLLt1k 
    #Given Genareted sin
