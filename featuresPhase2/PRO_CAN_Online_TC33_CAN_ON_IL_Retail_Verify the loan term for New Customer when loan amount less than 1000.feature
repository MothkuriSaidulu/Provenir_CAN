##Scenario: CAN_ON_IL_Retail_Verify the loan term for New Customer when loan amount < 1000

Feature: CAN_ON_IL_Retail_Verify the loan term for New Customer when loan amount < 1000

  @ILApprovedLt1k
  Scenario: CAN_ON_IL_Retail_Verify the loan term for New Customer when loan amount < 1000|TC33_New_D1_IL_Lt1k
