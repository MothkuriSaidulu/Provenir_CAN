##Scenario:: TC13_Verify loan decission for Refinance loan with Decile3
Feature: TC13_Verify loan decission for Refinance loan with Decile3

  @ILRefinanceApproved
  Scenario: TC13_Verify loan decission for Refinance loan with Decile3|TC13_D3_Refi_Appr 
    Given Genareted sin
    Given user click on signup customer
    And Pre-requisite data generation for customer
    And verify the phonenumber threshold
    When Create customer
    And Run the TU query general D "3" and FICO score "541"
   ...
   #################################GENERIC####################################
   And Run the TU query general ReRefEa D "3" and FICO score "719"
   #################################GENERIC####################################
