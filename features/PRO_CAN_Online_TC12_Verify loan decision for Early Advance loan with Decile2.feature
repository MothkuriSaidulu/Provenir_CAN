##Scenario:: TC12_Verify loan decision for Early Advance loan with Decile2
Feature: TC12_Verify loan decision for Early Advance loan with Decile2

  @ILRefinanceApproved
  Scenario: TC12_Verify loan decision for Early Advance loan with Decile2|TC12_D3D2_EA_Appr 
    Given Genareted sin
    ...
    And Run the TU query general D "3" and FICO score "719"
   ...
   #################################GENERIC####################################
   And Run the TU query general ReRefEa D "2" and FICO score "620"
   #################################GENERIC####################################
