...
Feature: TC24_ Verify Loan decission is denied when annual income < 1K

  @ILApprovedd
  Scenario: TC24_ Verify Loan decission is denied when annual income < 1K|TC24_incomeless1k_Decln
