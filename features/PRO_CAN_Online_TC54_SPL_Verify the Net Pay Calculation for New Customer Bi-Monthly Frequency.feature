...
##Scenario:: TC02_Verify the Net Pay Calculation for New Customer Bi-Monthly Frequency.
Feature: TC54_Verify the Net Pay Calculation for New Customer Bi-Monthly Frequency.

  @SPLApproved
  Scenario: TC54_Verify the Net Pay Calculation for New Customer Bi-Monthly Frequency.|TC54_New_SPL_Appr_NetPayCalc
   Given Genareted sin
